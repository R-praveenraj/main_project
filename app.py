...
# # Place the reset button on the right side of the interface
# col1, col2 = st.columns([3, 1])
# col1.button("Reset", on_click=lambda: st.session_state.clear())
# col2.empty()  # Placeholder for alignment
...
# Button to recommend movies on IMDb
btn_imdb = st.button("Recommend me movies on IMDb")
if btn_imdb:
    if not emotion:
        st.warning("Please let me capture your emotion first")
        st.session_state["run"] = "true"
...
# Streamlit app
st.title('AI Generated Music (MUSICALLY)')
